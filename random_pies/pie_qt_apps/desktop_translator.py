...
class TranslatorApp(QWidget):
    ...
    def setup(self):
        ...
        self.setWindowTitle("Python's Translator")
        self.initUI()
        self.events()
...
TransMitteR""")
        ...
        self.title.setStyleSheet("QLabel {padding: 2px; color: #05b5fd;}")
        ...
        self.input_option.setStyleSheet("QComboBox {border:3px solid #ff99ff; border-radius: 10px;"
                                     "padding: 6px; background: #333333; color: #05b5fd;}")
        ...
        self.trans_button.setStyleSheet("QPushButton {border:3px solid #ff99ff; border-radius: 10px;"
                                     "padding: 10px; background: #333333; color: #05b5fd;}")
