...
from enclosure import Terrestrial_Enclosure
katie = GateKeeper("Katie", "Gate Cashier")
...
# 2. Assign the employee (This updates the lists AND Richard's building/wing)
